...
if ( isset($_GET['banuser']) ) $banuser = (int)parseToDB($_GET['banuser']);
if ( isset($_GET['unbanuser']) ) $banuser = (int)parseToDB($_GET['unbanuser']);
if ( isset($_GET['n']) ) $n = parseToDB($_GET['n']);
