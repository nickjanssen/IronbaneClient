...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ironbane` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Data for the table `forum_cats` */

insert  into `forum_cats`(`id`,`name`,`order`,`modonly`) values (1,'General',3,0),(2,'Announcements',1,0),(4,'Ironbane Team',2,1);
...
/*Data for the table `forum_ratings` */
...
/*Data for the table `ib_characters` */
...
/*Data for the table `ib_editor_cats` */

insert  into `ib_editor_cats`(`id`,`name`,`range`,`limit_x`) values (1,'Alpha tiles','1-100',10),(2,'Special','1650-1700',10);
...
/*Data for the table `ib_gameobjects` */

insert  into `ib_gameobjects`(`id`,`name`,`type`,`param`) values (1,'Test',3,1),(6,'Bush_Symetrical',3,6);
...
CREATE TABLE `ib_meshes` (
  ...
  `filename` varchar(50) NOT NULL COMMENT '.Obj file format|upload|plugins/game/images/meshes/',
...
/*Data for the table `ib_team_actions` */
...
/*Data for the table `ib_zones` */

insert  into `ib_zones`(`id`,`name`,`type`) values (1,'World',1),(2,'Developer\'s Zone',2),(3,'Tutorial',2),(4,'Ironbane\'s Castle',2),(6,'Bunny Hole',2),(5,'Ironbane\'s Chamber',2),(7,'Underwater River',2),(8,'Catacombs',2),(10,'Heart Dungeon',2),(9,'Cave',2);
